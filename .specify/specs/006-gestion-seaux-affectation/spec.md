...
- **FR-007** (nouveau, Clarifications 2026-09-24) : le système DOIT permettre de retirer le cueilleur d'un seau via `DELETE /api/buckets/{bucketId}/picker` (`204`, ou `404` si le seau n'existe pas). Non implémenté aujourd'hui (route absente de `api.yaml`).
