...
class AccessMatrixSecurityTest {
    ...
    static List<Route> routes() {
        return List.of(
                ...
                new Route(HttpMethod.DELETE, "/api/tags/registration-sessions/" + ID, null, ADMIN_ONLY),
                new Route(HttpMethod.POST, "/api/tags/registration-sessions/" + ID + "/save",
                        "{\"bucketNumber\":1}", ADMIN_ONLY),
                ...
                new Route(HttpMethod.GET, "/api/records/stats", null, LOGGED_IN),
