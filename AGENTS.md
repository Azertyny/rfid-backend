...
- `/src`: Principal source code of the application
...
- Use Java for all new code generated by OpenAI Codex
- OpenAI Codex should follow the existing code style in each file
- Agents.md requires meaningful variable and function names in OpenAI Codex output
- OpenAI Codex should add comments in english for complex logic as guided by Agents.md
